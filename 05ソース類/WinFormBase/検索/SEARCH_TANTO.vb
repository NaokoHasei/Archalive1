...
Public Class SEARCH_TANTO
    ...
    Private Sub Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim logic As New BLL.SEN.SEARCH_TANTO
    ...
    Private Sub subInitGrid()
        ...
        'Dim logic As New BLL.SEN.SEARCH_TANTO
        'gridData.DataSource = logic.GetTANTOData(where)
        ...
        With gridData
            ...
            .Columns(COL_MENUKEY).DataWidth = 20
            .Columns(COL_NAME).DataWidth = 20
            ...
            With .Splits(0)
                ...
                .DisplayColumns(COL_MENUKEY).Width = (19 + 4) * 8
                .DisplayColumns(COL_NAME).Width = (19 + 4) * 8
    ...
    Private Function SetParameter() As Boolean
        ...
        _SelectParam = New SelectParameter_M_TANTO
        With _SelectParam
    ...
    Private _SelectParam As SelectParameter_M_TANTO

    Public ReadOnly Property SelectItem() As SelectParameter_M_TANTO
        Get
            Return _SelectParam
        End Get
    End Property

    Private Sub SEARCH_TANTO_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown, _
                                                                                                                       fraMain.MouseDown, _
    ...
    Private Sub SEARCH_TANTO_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseMove, _
                                                                                                                       fraMain.MouseMove, _
...
Public Class SelectParameter_M_TANTO
