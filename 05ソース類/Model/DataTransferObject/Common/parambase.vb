Namespace DTO
    ...
    Public MustInherit Class RequestParamBase
        ...
        Private requestUPDATEPGID As String
        Private requestUPDATEUSERCODE As String
        ...
        Public Property UPDATEPGID() As String
            Get
                Return requestUPDATEPGID
            End Get
            Set(ByVal value As String)
                requestUPDATEPGID = value
            End Set
        End Property

        Public Property UPDATEUSERCODE() As String
            Get
                Return requestUPDATEUSERCODE
            End Get
            Set(ByVal value As String)
                requestUPDATEUSERCODE = value
            End Set
        End Property
        ...
        Public Overrides Function ToString() As String
            ...
            While Not (IsNothing(objtyp))
                ...
                If objtyp.FullName = "Model.DTO.RequestParamBase" Then
                    Exit While
                End If
    ...
    Public Class ResponseDataSet
        Inherits ResponseValueBase
        Implements IValueState
        Implements IItem(Of DataSet)

        Private _hasValue As Boolean
        Private responseList As DataSet

        Public ReadOnly Property Item() As DataSet
            Get
                Return responseList
            End Get
        End Property
    ...
    <Serializable()> _
    Public Class ResponseTypedDataSet(Of TDataSet As {DataSet, IValueState})
        Inherits ResponseValueBase
        Implements IValueState
        Implements IItem(Of DataSet)
    ...
    <Serializable()> _
    Public Class ResponseReportBase(Of TDataSet As {DataSet})
        Inherits ResponseValueBase
        Implements IValueState
        Implements IItem(Of DataSet)
