...
Public Class rptHAT0001Uke

    Private _DataSetHeader As dsHAT0001_Report.鏡_請書DataTable
    ...
    Public Sub New(
        ...
        _DataSetHeader = ReportDataSets.鏡_請書
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        With _DataSetHeader.Item(0)
            ...
            txtNOUKI_START.Text = ""
            txtNOUKI_END.Text = ""
            If Not CommonUtility.Utility.NUCheck(.NOUKI_START) Then txtNOUKI_START.Text = BLL.Common.GetCnvSW.SfncYearSW(CType(.NOUKI_START, DateTime).ToString("yyyy/MM/dd"), True)
            If Not CommonUtility.Utility.NUCheck(.NOUKI_END) Then txtNOUKI_END.Text = BLL.Common.GetCnvSW.SfncYearSW(CType(.NOUKI_END, DateTime).ToString("yyyy/MM/dd"), True)
